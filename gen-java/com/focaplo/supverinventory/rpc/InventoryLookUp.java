...
public class InventoryLookUp implements TBase<InventoryLookUp._Fields>, java.io.Serializable, Cloneable, Comparable<InventoryLookUp> {
  private static final TStruct STRUCT_DESC = new TStruct("InventoryLookUp");
  ...
  static {
    FieldMetaData.addStructMetaDataMap(InventoryLookUp.class, metaDataMap);
  }
   ...
   */
  public InventoryLookUp(InventoryLookUp other) {
  ...
  public InventoryLookUp deepCopy() {
    return new InventoryLookUp(this);
  }

  @Deprecated
  public InventoryLookUp clone() {
    return new InventoryLookUp(this);
  }
  ...
  public InventoryLookUp setUid(int uid) {
    this.uid = uid;
    setUidIsSet(true);
    return this;
  }
  ...
  public InventoryLookUp setItemNumber(String itemNumber) {
    this.itemNumber = itemNumber;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof InventoryLookUp)
      return this.equals((InventoryLookUp)that);
    return false;
  }

  public boolean equals(InventoryLookUp that) {
    if (that == null)
      return false;
  ...
  public int compareTo(InventoryLookUp other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    InventoryLookUp typedOther = (InventoryLookUp)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("InventoryLookUp(");
    boolean first = true;
